...
Cada usuário possui um ambiente exclusivo e seguro, onde pode registrar informações sobre seus estudos, acompanhar o tempo dedicado às matérias e monitorar sua evolução acadêmica de forma simples e intuitiva.
...
* Registrar as matérias estudadas;
* Informar o tempo dedicado aos estudos;
* Utilizar um temporizador durante as sessões de estudo;
* Visualizar a quantidade de matérias salvas;
* Manter suas anotações privadas e organizadas.
...
* Adicionar a matéria estudada;
* Registrar quanto tempo estudou;
...
* Quantidade total de matérias cadastradas;
